...
import bench_ar_codec as common
import torch
...
def collect_and_write(
    ...
    summary = {
        ...
        "candidate": "same installed path for M32/M24; packed mach_lossless_prefill twoshot only for M4096, launch_with_pdl=True",
    ...
    try:
        ...
        fixture_by_round = [
            ...
            next(
                (
                    fixture
                    for fixture in common.synthetic_fixtures(device)
