...
The service used vLLM 0.28, PyTorch 2.13.0+cu130, ExLlamaV3 1.4.8 with BF16 I/O, patched FlashInfer 0.6.18, B12X 1.3.0 and mxfp6-sm120 0.2.1. The [archived long-prefill profile](https://github.com/troycheng/vllm-mach/blob/2570a110c47de5a09a2dcc3324b8572c8ed596cd/profiles/vllm-0.28.0/qwen38-checkpoint-long.env) enabled Temporal M24, BA32 and lossless prefill collectives. It is historical EXL3/v0.28 material, not a current native MXFP6 installation path. It used FP32 recurrent state, TRITON_ATTN, FULL_DECODE_ONLY and automatic KV allocation of 324,169 tokens. All 640 requests completed in one lifecycle.
