...
[Raw request counts, latencies, throughput, warmup settings and launch configurations](data/native-serving-20260915.json)
...
[Raw per-query logprobs, bootstrap inputs, runtime settings and head observations](data/native-fidelity-20260915.json)
