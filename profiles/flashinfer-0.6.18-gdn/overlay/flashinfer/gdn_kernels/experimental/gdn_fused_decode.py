...
try:
    ...
    # FlashInfer 0.6.16 has the generic GDN trace definitions but predates
    # this experimental fused-decode trace. Tracing is optional at runtime.
    gdn_fused_decode_trace = None
