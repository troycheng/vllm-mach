...
"""Order eager launches that share the persistent kernel barrier and scratch.

Ported with the historical FlashInfer persistent host support. Captured graph
replays must still be serialized by the caller.
"""
